...
copy direct_api.py direct_api_compatible.py
python -c "with open('direct_api_compatible.py', 'r') as f: content = f.read(); content = content.replace('MODEL_PATH = \"models/saved_models/sentiment_model.joblib\"', 'MODEL_PATH = \"models/saved_models/sentiment_model_compatible.joblib\"').replace('VECTORIZER_PATH = \"data/processed/vectorizer.joblib\"', 'VECTORIZER_PATH = \"data/processed/vectorizer_compatible.joblib\"'); with open('direct_api_compatible.py', 'w') as f: f.write(content)"
